...
page 50002 "DY APIV2 - Sales Invoices"
{
    ...
    APIGroup = 'DYdemo';
    APIVersion = 'v2.0';
    EntitySetName = 'DYAPISalesInvoices';
    EntityName = 'DYAPISalesInvoice';
    EntitySetCaption = 'DYAPISalesInvoices';
    EntityCaption = 'DYAPISalesInvoice';
